...
<template>
  <div
    class="w-screen h-screen relative bg-slate-50 overflow-hidden flex justify-end items-center"
  >
    <img
      src="~assets/images/loginimage.png"
      alt="Login Image"
      class="w-[1722.15px] h-[1466.45px] left-[-7px] top-[-222px] absolute"
    />
    <div class="mx-0 mb-4 sm:ml-4 xl:mr-4 relative z-10">
      <div
        class="w-screen max-w-[400px] h-full bg-white border-gray-400 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700 mr-16"
      >
