<template>
  <div>
                      ...
                      <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-2">
                          ...
                          <div class="w-full">
                            ...
                            <input
                              type="text"
                              v-model="particularDescription"
                              id="particularDescription"
                              class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            />
    ...
    <div class="mb-2 ml-10">
      <label class="font-bold text-3xl">List of Bookings</label>
    </div>
              ...
              <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                    ...
                    <tbody>
                      ...
                      <template v-if="sortedItems && sortedItems.length > 0">
                        <tr
                          ...
                          v-for="(particular, index) in sortedItems"
                        >
                          ...
                          <td
                            class="whitespace-nowrap b px-6 py-4 dark:border-white/10"
                          >
                            {{ formatDate(particular.createdDate) }}
                          </td>
                          <!-- <td
                            class="whitespace-nowrap b px-6 py-4 dark:border-white/10"
                          >
                            {{ reimbursement.toCharge }}
                          </td> -->
                ...
                <div class="flex items-center justify-between">
                  <span class="small mr-3"
                    ...
                    of
                    <span id="totalpages"
                      >{{ particularData.totalpages }} Entries</span
                    ></span
                  >
                  ...
                  >
                    <ul class="inline-flex items-center -space-x-px">
                      <Paginate
                        v-if="particularData.totalpages > 1"
                        class=""
                        v-model="paginate"
                        :page-count="particularData.totalpages"
